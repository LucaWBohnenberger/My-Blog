...
Todos os 3 axiomas são bastante razoaveis, o primeiros diz que uma probabilidade é um valor entre 0 e 1, caso não esteja acostumado a ver probabilidade como por exemplo 0.55, e sim como 55%, saiba que é a mesma coisa, pois % é utilizado como sinonimo de divisão por 100.

O segundo axioma nos diz, que a probabilidade de algo no espaço amostral ocorrer é de 100%. Como exemplo, pense em jogar um dado de 6 lados, digamos que definimos os eventos como o numero que cair no dado, então teremos $E_1, E_2, E_3, E_4,E_5,E_6$. Onde cada um desses é representado abaixo
$$
\begin{aligned}
E_1 &= \{1\} \\
E_2 &= \{2\} \\
